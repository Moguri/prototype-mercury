...
event-map-item-move-left raw-a arrow_left gamepad0-dpad_left
event-map-item-move-right raw-d arrow_right gamepad0-dpad_right
event-map-item-move-down raw-s arrow_down gamepad0-dpad_down
event-map-item-move-up raw-w arrow_up gamepad0-dpad_up
